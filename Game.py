...
player_Agent_score = 0
player_Smith_score = 0
...
pen.hideturtle()
pen.goto(0,260)
pen.write("Player Agent: 0                    Player Smith: 0 ",align="center",font=('Monaco',24,"normal"))
...
while True:
    ...
    if ball.xcor() > 390:   # right width paddle Border
        ...
        pen.clear()
        pen.write("Player Agent: {}                    Player Smith: {} ".format(player_Agent_score,player_Smith_score),align="center",font=('Monaco',24,"normal"))
